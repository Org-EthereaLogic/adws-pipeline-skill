...
| grader_verdict | fail | fail — Grader verdict recorded fail — AC-coverage drift BLOCK (PR_DRIFT_SENTINEL_BLOCK) |
...
- Gate "grader_verdict" evaluated to fail: Grader verdict recorded fail — AC-coverage drift BLOCK (PR_DRIFT_SENTINEL_BLOCK)
