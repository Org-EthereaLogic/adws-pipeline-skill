...
| drift_verdict | fail | BLOCK — drift_verdict recorded BLOCK (PR_DRIFT_SENTINEL_BLOCK) |
...
- Gate "drift_verdict" evaluated to fail: drift_verdict recorded BLOCK (PR_DRIFT_SENTINEL_BLOCK)
