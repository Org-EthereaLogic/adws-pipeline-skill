...
| build | 1 | fail | BUILD_GATE_FAILURE | sonnet | `build/attempt_1/` |
...
- Phase "build" passed on attempt 2 (attempt(s) 1..1 gate-failed — attempt 1: BUILD_GATE_FAILURE).
