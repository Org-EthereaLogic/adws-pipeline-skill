...
function isVerifiable(criterion) {
  ...
  // F-32 finished that job on `output`, whose first replacement still admitted the
  // misspellings "outputed"/"outputing". Every alternative matches real forms only — a
  // non-word classifying as behavioral would suppress the vagueness warning for free.
